    ...
    <div class="row mt-5">
        <div class="col-1"></div>
            ...
            if (isset($_POST['btn_view_client'])){
                ...
                $client_name = mysqli_real_escape_string($connection, check_input($_POST['view_client_name']));
                ...
                <div class="col-4 border">
                    ...
                    <button type="button" class="btn btn-primary mb-5 mt-5" data-toggle="modal" data-target="#staticBackdrop2">
